...
public class lists extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nom_list.add("سلمان الميلود");
        nom_list.add("بلعطاف مراد");
        nom_list.add("بلعسل عبد القادر");
        nom_list.add("شعاف محمد");
        nom_list.add("مساد قدور");
        nom_list.add("عوان عمار");
        nom_list.add("مساد بن عمر");
        nom_list.add("Taxi ذري أحمد");
        nom_list.add("عوان عبد القادر");
        nom_list.add("Taxi راموس أحمد");
        nom_list.add("ناقل اسماعيل");
        nom_list.add("راموس محمد");
        nom_list.add("سلمان عبد القادر");
        nom_list.add("أيمن محمد");
        nom_list.add("عماني عبد القادر");
        nom_list.add("مرابط علي");
        nom_list.add("محرز محمد");
        nom_list.add("مقراني أحمد");
        nom_list.add("طالبي محمد");
        nom_list.add("راموس أمحمد");
        nom_list.add(" بزي بن علي");
        nom_list.add("عوان الجيلالي");
        nom_list.add("أيمن محمد");
        nom_list.add("مشاش عبد القادر");
